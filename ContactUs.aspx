...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="contact-form-02/css/style.css">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Contact Us Form</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-12">
					<div class="wrapper">
						<div class="row no-gutters">
				            ...
				            Your message was sent, thank you!
									...
									<form method="POST" id="contactForm" runat="server" action="#" name="contactForm" class="contactForm">
										<div class="row">
											<div class="col-md-6">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<asp:TextBox ID="txtMessage"  class="form-control" TextMode="MultiLine" placeholder="Enter Message" runat="server"></asp:TextBox>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
				        	...
				        	<div class="dbox w-100 d-flex align-items-start">
				        		...
				        		<div class="text pl-3">
					            <p><span>Address:</span>120 near Gcoea kathora naka Amravati 444604</p>
					          </div>
				          </div>
				        	...
				        	<div class="dbox w-100 d-flex align-items-center">
				        		...
				        		<div class="text pl-3">
					            <p><span>Email:</span> <a href="mailto:info@yoursite.com">evstationmaster@gmail.com</a></p>
					          </div>
				          </div>
				        	<div class="dbox w-100 d-flex align-items-center">
				        		<div class="icon d-flex align-items-center justify-content-center">
				        		...
				        		<div class="text pl-3">
					            <p><span>Website</span> <a href="#">www.charging station master.com</a></p>
					          </div>
				          </div>
			          </div>
							</div>
