<%@ Page Title="" Language="C#" MasterPageFile="~/station/StationMasterPage.master" AutoEventWireup="true" CodeFile="stationbooking.aspx.cs" Inherits="station_stationbooking" %>
...
<div class="card" >
     ...
     <div class="col-md-12" >
                 ...
                 <asp:Panel ID="Panel1" runat="server"  Width="100%">
                  ...
                  <ItemTemplate> 
                    <asp:HyperLink ID="view1" Text="Update Status" Class="btn btn-warning btn-sm" runat="server" NavigateUrl='<%#"SbookingStatus.aspx?slotID="+ Server.UrlEncode(Eval("slotID").ToString()) %>' ForeColor="White" Font-Size="Medium" Font-Bold="True" />
                  </ItemTemplate>
