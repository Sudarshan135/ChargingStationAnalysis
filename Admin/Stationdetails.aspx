<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Stationdetails.aspx.cs" Inherits="Admin_Stationdetails" %>
...
<div class="card">
     ...
     <div class="col-md-4" >
        ...
        <div class="form-group" style="border:thin solid #000000;border-radius:20px"">
          <center>   <asp:Label ID="Label2" runat="server" Text="pincode" Font-Bold="True" style="text-align: center"  ></asp:Label>   </center>
                        <asp:TextBox ID="txtpincode"  class="form-control "   placeholder="State" runat="server" ForeColor="#000066" style="text-align: center" Font-Bold="True"></asp:TextBox>
          ...
          <div class="form-group" style="border:thin solid #000000 ;border-radius:20px"">
              <center>   <asp:Label ID="Label3" runat="server" Text="Area" Font-Bold="True" style="text-align: center"  ></asp:Label>   </center>
         ...
         <div class="form-group" style="border:thin solid #000000;border-radius:20px"" >
               <center>  <asp:Label ID="Label10" runat="server" Text="Charger Types" Font-Bold="True"></asp:Label>   
                <center>   <asp:Label ID="Label12" runat="server" Text="Rapid Charger-50KW+" Font-Bold="True" style="text-align: center"  ></asp:Label>   </center>
                       ...
                       <center>   <asp:Label ID="Label13" runat="server" Text="Fast Charger" Font-Bold="True" style="text-align: center"  ></asp:Label>   </center>
                        <asp:TextBox ID="txtfast" placeholder="Fast Charger" class="form-control "  style="text-align: center" runat="server" ForeColor="#000066" Font-Bold="True" TextMode="Number"></asp:TextBox>
                        
                     <center>   <asp:Label ID="Label14" runat="server" Text="Slow Charger" Font-Bold="True" style="text-align: center"  ></asp:Label>   </center>
                        <asp:TextBox ID="txtslow" placeholder="Slow Charger" class="form-control "  style="text-align: center" runat="server" ForeColor="#000066" Font-Bold="True" TextMode="Number"></asp:TextBox>
   ...
   <center> <asp:Button ID="btnsave" runat="server" Text="Save" Visible="false" class="btn btn-raised waves-effect g-bg-cyan" OnClick="btnsave_Click" /></center>
          
    <br />
     <center> <asp:Button ID="btnStatus" runat="server" Text="Active/Deactive"  class="btn btn-raised waves-effect g-bg-cyan" OnClick="Button1_Click"  /></center>
